        ...
        <div class="card ">
            ...
            <div class="section header">
                <div class="container-lg">
                    <div class="row">
                        <div class="col-lg-12" >
                            <div class="card-body" id="table_mahasiswa">
                            <h1 class="text-center">Daftar Mahasiswa</h1>
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <a href="tambah_mahasiswa.php" type="button" class="btn btn-primary">Tambah mahasiswa</a>
                                    </div><!-- /input-group -->
                                </div><!-- /.col-lg-6 -->
                                        <!-- search -->
                                    <div class="col-md-6">
                        ...
                        <div class="table-responsive" >
                                <table class="table" cellpadding="10" border="1" cellspacing="0">
                                    ...
                                    <tr>
                                        <td><?= $i ?></td>
                                        <td>
                                <a href="ubah_mahasiswa.php?id=<?=$row["id"]; ?>"><button class="btn btn-primary" value="submit">Ubah</button></a> | 
