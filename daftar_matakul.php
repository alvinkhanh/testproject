    ...
    <div class="col-lg-5">
        ...
        <form method="post">
                <div class="form-group">
                    ...
                    <input class="form-control" id="field1" name="kode_matkul" placeholder="Masukan Kode Mata Kuliah" required>
                </div>
                <div class="form-group">
                    <label>Nama Mata Kuliah</label>
                        <input class="form-control" name="nama_matkul" placeholder="Masukan Nama Mata Kuliah" required>
                </div>
        ...
        if(@$_POST['input']){
            ...
            $query=mysqli_query($conn, "INSERT INTO matkul(kode_matkul, nama_matkul) values('$kode_matkul','$nama_matkul')") or die (mysqli_error());
            
            if($query){
            ?>
                <script type="text/javascript">
                alert("Input Data Sukses !")
                window.location="daftar_matakul.php";
                </script>
            <?php
            }else{
            ?>
