                        ...
                        <div class="row">
                           <div class="col-sm-12">
                                ...
                                <div class="row">    
                                    ...
                                    <div class="form-group">
                                            <label>Email</label>
                                            <input class="form-control" name="email" placeholder="email" value="<?=$dosen["email"];?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Tanggal Lahir</label>
                                            <input type="text" class="form-control" name="tanggal_lahir" id="datepicker" value="<?=$dosen["tanggal_lahir"];?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Alamat</label>
                                            <input class="form-control" name="alamat" placeholder="Alamat" value="<?=$dosen["alamat"];?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Agama</label>
                                ...
                                <div class="container px-lg-5" id="table_gambar">    
                                    <div class="row mx-lg-n5">
                                        <div class="col py-3 px-lg-5 border bg-light" id="ubah_gambar_dosen">
                                            <div class="card text-center" style="width: 18rem;" id="card_gambar">
                                                <a href="#" class="thumbnail">
                                                    ...
                                                    <img class="card-img-top" src="assets/image/<?= $dosen["gambar"]?>" width="200" alt="">
                                                </a>
                                        </div>
                                    </div>
                                        <div class="col py-3 px-lg-5 border bg-light" id="ubah_gambar_dosen">
